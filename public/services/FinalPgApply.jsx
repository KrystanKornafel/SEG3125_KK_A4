...
//======================== Final Page for the Job Application ====================================================================================
// Name: Krystan Kornafel
// Assignment: SEG3125 Assignment 2
// Description: This React UI will be used as a way of acknowledging the user when they submit a job application on the Apply Now
//(aka "We are Hiring!") page. After their application is received, they are redirected to this page, and an image will appear, 
//along with a message informing the user that their application has been received. 
  ...
  return (
    <>
      ...
      <div style={{ backgroundColor: '#c473ca' }}>
          ...
          <div className="container mt-5">
            <div className="mb-5">
              <div className="d-flex justify-content-center align-items-center" style={{ backgroundColor: '#5BE5CE', width: "930px", height: "600px", display: "flex", alignItems: "center", gap: "2px"}}>
                {/* Image generated by Copilot */}
                <img src="/Joyful_lady_Job_App.png" className="float-start me-3 rounded" style={{ width: "300px" }} alt="logo" />
                <div style={{ backgroundColor: '#4FE5F5', width: "300px", height: "300px"}}>
                  {/* Reference for styling: https://www.pluralsight.com/resources/blog/guides/react-inline-styling */}
                  <p style={{ color: '#000000', fontSize: "30px", fontWeight: 700 }}><br/>Yay! You applied!<br/>We’ll contact you soon!</p><br/>
                </div>
              </div>
            </div>
          </div>
